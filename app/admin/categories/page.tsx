  ...
  return (
    <>
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-5 border border-zinc-200">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-zinc-900 tracking-tight">{stats.active}</p>
            )}
          ...
          <div className="bg-white rounded-xl p-5 border border-zinc-200">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-zinc-900 tracking-tight">{stats.inactive}</p>
            )}
          ...
          <div className="bg-white rounded-xl p-5 border border-zinc-200">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-zinc-900 tracking-tight">{stats.totalProducts}</p>
            )}
        ...
        {isLoading ? (
          <div className="bg-white rounded-xl border border-zinc-200 p-12 text-center">
            <iconify-icon icon="lucide:loader-2" width="32" className="animate-spin text-zinc-400 mx-auto"></iconify-icon>
            <p className="text-sm text-zinc-500 mt-4">Loading categories...</p>
          </div>
        ) : filteredCategories.length === 0 ? (
          <div className="bg-white rounded-xl border border-zinc-200 text-center py-16">
            <div className="w-16 h-16 rounded-full bg-zinc-100 flex items-center justify-center mx-auto mb-4">
              <iconify-icon icon="lucide:folder-x" width="32" className="text-zinc-400" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
            </div>
            <h3 className="text-lg font-semibold text-zinc-900 mb-2">No categories found</h3>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredCategories.map((category) => (
                    <tr key={category.id} className="border-b border-zinc-50 hover:bg-zinc-50/50 transition-colors group">
                          ...
                          <div className="w-12 h-12 rounded-lg overflow-hidden bg-zinc-100 flex-shrink-0 relative">
                            {category.imageUrl ? (
                              ...
                              <div className="w-full h-full flex items-center justify-center">
                                <iconify-icon icon="lucide:image" width="20" className="text-zinc-300" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
                              </div>
                            )}
                          </div>
                          <div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-medium text-zinc-900">{category._count?.products || 0}</span>
      ...
      {(isAddModalOpen || isEditModalOpen) && (
        <div className="fixed inset-0 bg-zinc-900/70 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl">
            ...
            <div className="p-6">
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div
                    className="border-2 border-dashed border-zinc-200 rounded-xl p-6 text-center hover:border-amber-400 hover:bg-amber-50/30 transition-colors cursor-pointer"
                ...
                {/* Status Toggle */}
                <div>
                  <label className="block text-sm font-medium text-zinc-700 mb-3">Status</label>
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
            ...
            <div className="flex items-center justify-end gap-3 p-6 border-t border-zinc-100 bg-zinc-50">
              ...
              <button
                ...
                disabled={isSaving}
                className="px-4 py-2.5 text-sm font-medium text-white bg-zinc-900 rounded-lg hover:bg-zinc-800 transition-colors disabled:opacity-50 flex items-center gap-2"
              >
