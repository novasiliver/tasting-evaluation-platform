  ...
  return (
    <div className="flex h-screen">
        ...
        <header className="bg-white border-b border-zinc-200/80">
          <div className="flex items-center justify-between px-8 h-14">
            <div className="flex items-center gap-3">
              <h1 className="text-base font-semibold text-zinc-900">Certificate Templates</h1>
              <span className="px-2 py-0.5 text-xs font-medium text-amber-700 bg-amber-50 rounded-full">Preview</span>
            </div>
          </div>
        </header>
      </div>
      ...
      <div className="flex flex-1 pt-14">
        ...
        <div className="w-96 border-r border-zinc-200/80 bg-white overflow-y-auto">
          <div className="p-6">
            <h2 className="text-sm font-semibold text-zinc-900 mb-1">Available Templates</h2>
            <p className="text-xs text-zinc-500 mb-6">Select a template to preview</p>
                  ...
                  <div className={`p-4 border-2 rounded-xl transition-all ${
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-zinc-500">Score Range: {template.range}</p>
                      </div>
                      {selectedTemplate === template.value && (
                        <iconify-icon icon="lucide:check-circle" width="20" className="text-amber-600" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
                      )}
                    </div>
                  </div>
                </label>
            ...
            <div className="mt-6 p-4 bg-zinc-50 rounded-lg border border-zinc-200">
              <h3 className="text-xs font-semibold text-zinc-900 mb-2">Template Information</h3>
              <div className="space-y-2 text-xs text-zinc-600">
                <div className="flex justify-between">
                  <span className="text-zinc-500">Award Level:</span>
                ...
                <div className="flex justify-between">
                  <span className="text-zinc-500">Award Title:</span>
        ...
        <div className="flex-1 bg-zinc-100 overflow-y-auto p-8">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
              <span className="text-sm font-medium text-zinc-600">Template Preview</span>
            </div>
          </div>
            ...
            <div className="w-full max-w-2xl aspect-[1/1.414] bg-white rounded-xl shadow-2xl overflow-hidden relative">
              <div className={`absolute inset-4 border-4 ${colors.border} rounded-lg p-8 flex flex-col items-center bg-gradient-to-b ${colors.bg}`}>
                ...
                <h2 className={`text-3xl font-bold tracking-tight mb-4 ${
                  ...
                  selectedTemplate === 'gold' ? 'text-amber-700' :
                  selectedTemplate === 'silver' ? 'text-zinc-700' :
                  'text-orange-700'
                }`}>
