  ...
  return (
    <>
      ...
      <header className="bg-white border-b border-stone-200/80 sticky top-0 z-30">
        <div className="flex items-center justify-between px-8 h-14">
          <div className="flex items-center gap-3">
            <h1 className="text-lg font-semibold text-stone-900 tracking-tight">Product Submissions</h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button className="w-9 h-9 rounded-lg border border-stone-200 flex items-center justify-center hover:bg-stone-50 transition-colors">
              <iconify-icon icon="lucide:help-circle" width="18" className="text-stone-500" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
            </button>
          </div>
        </div>
      </header>
      ...
      <div className="p-8">
        {/* Page Header */}
        <div className="mb-6">
          <p className="text-sm text-stone-500">Review and evaluate product submissions from producers</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-xl border border-stone-200/80 p-5">
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-stone-100 flex items-center justify-center">
                <iconify-icon icon="lucide:inbox" width="20" className="text-stone-600" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
              </div>
              <span className="text-xs font-medium text-stone-400">Total</span>
            </div>
            {isLoading ? (
            ...
            <p className="text-xs text-stone-500 mt-1">All submissions</p>
          </div>
          <div className="bg-white rounded-xl border border-stone-200/80 p-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-medium text-gold-600">Pending</span>
            </div>
            {isLoading ? (
              <div className="h-8 w-16 bg-stone-100 rounded animate-pulse"></div>
            ) : (
          ...
          <div className="bg-white rounded-xl border border-stone-200/80 p-5">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-stone-900 tracking-tight">{stats.underReview}</p>
            )}
            <p className="text-xs text-stone-500 mt-1">Being evaluated</p>
          </div>
          <div className="bg-white rounded-xl border border-stone-200/80 p-5">
            <div className="flex items-center justify-between mb-3">
            ...
            {isLoading ? (
              ...
              <p className="text-2xl font-semibold text-stone-900 tracking-tight">{stats.evaluated + stats.certified}</p>
            )}
            <p className="text-xs text-stone-500 mt-1">Evaluated & Certified</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-stone-200/80">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 text-sm border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500/20 focus:border-gold-500 transition-colors"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="relative">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-stone-600 bg-white border border-stone-200 rounded-lg hover:bg-stone-50 transition-colors"
                  >
                    <iconify-icon icon="lucide:tag" width="16" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                  ...
                  {isCategoryDropdownOpen && (
                    <div className="absolute top-full mt-2 left-0 bg-white border border-stone-200 rounded-lg shadow-lg py-2 z-10 min-w-[180px] max-h-64 overflow-y-auto">
                      <button onClick={() => { setCategoryFilter(''); setIsCategoryDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">All Categories</button>
                      {categories.map((cat) => (
                        <button
                          key={cat.id}
                ...
                <div className="relative">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-stone-600 bg-white border border-stone-200 rounded-lg hover:bg-stone-50 transition-colors"
                  >
                    <iconify-icon icon="lucide:filter" width="16" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                    <span>{statusFilter || 'All Statuses'}</span>
                    <iconify-icon icon="lucide:chevron-down" width="16" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                  </button>
                  {isStatusDropdownOpen && (
                    <div className="absolute top-full mt-2 left-0 bg-white border border-stone-200 rounded-lg shadow-lg py-2 z-10 min-w-[180px]">
                      <button onClick={() => { setStatusFilter(''); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">All Statuses</button>
                      <button onClick={() => { setStatusFilter('Pending'); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">Pending</button>
                      <button onClick={() => { setStatusFilter('In Review'); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">In Review</button>
                      <button onClick={() => { setStatusFilter('Evaluated'); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">Evaluated</button>
                      <button onClick={() => { setStatusFilter('Certified'); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">Certified</button>
                      <button onClick={() => { setStatusFilter('Rejected'); setIsStatusDropdownOpen(false); }} className="w-full text-left px-4 py-2 text-sm text-stone-600 hover:bg-stone-50">Rejected</button>
                    </div>
                  )}
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-stone-600 bg-white border border-stone-200 rounded-lg hover:bg-stone-50 transition-colors"
                >
                  <iconify-icon icon="lucide:download" width="16" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                  Export
                </button>
                ...
                <tr className="border-b border-stone-100">
                  <th className="text-left px-6 py-4">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-stone-500 uppercase tracking-wider hover:text-stone-700 transition-colors"
                    >
                      Product Name
                      <iconify-icon icon={sortBy === 'name' ? (sortOrder === 'asc' ? 'lucide:arrow-up' : 'lucide:arrow-down') : 'lucide:arrow-up-down'} width="14" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                    </button>
                  </th>
                  <th className="text-left px-6 py-4">
                  ...
                  <th className="text-left px-6 py-4">
                    ...
                    >
                      Producer
                      <iconify-icon icon={sortBy === 'producer' ? (sortOrder === 'asc' ? 'lucide:arrow-up' : 'lucide:arrow-down') : 'lucide:arrow-up-down'} width="14" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                    </button>
                  </th>
                  <th className="text-left px-6 py-4">
                  ...
                  <th className="text-left px-6 py-4">
                    ...
                    >
                      Submission Date
                      <iconify-icon icon={sortBy === 'date' ? (sortOrder === 'asc' ? 'lucide:arrow-up' : 'lucide:arrow-down') : 'lucide:arrow-up-down'} width="14" style={{ strokeWidth: 1.5 } as React.CSSProperties} className="text-stone-400"></iconify-icon>
                    </button>
                  </th>
                  <th className="text-right px-6 py-4">
                    <span className="text-xs font-semibold text-stone-500 uppercase tracking-wider">Action</span>
                  </th>
                </tr>
              </thead>
                  ...
                  [1, 2, 3, 4, 5].map((i) => (
                    <tr key={i} className="hover:bg-stone-50/50">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-lg bg-stone-100 animate-pulse"></div>
                          <div>
                      ...
                      <tr key={item.id} className="hover:bg-stone-50/50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-stone-400">{item.details}</p>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-stone-600">{item.producer}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4">
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center gap-3">
                        <iconify-icon icon="lucide:inbox" width="48" className="text-stone-300" style={{ strokeWidth: 1.5 } as React.CSSProperties}></iconify-icon>
                        <p className="text-sm font-medium text-stone-600">No submissions found</p>
          ...
          {!isLoading && filteredSubmissions.length > 0 && (
            <div className="flex items-center justify-between p-5 border-t border-stone-100">
